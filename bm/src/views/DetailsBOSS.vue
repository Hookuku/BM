    ...
    <div class="container mb-5">
      <div class="row pr-3">
        <div id="preview" class="col pr-0">
          <div class="card bg-transparent mr-5 position-absolute">
            ...
            <div
              ...
              :class="{ 'd-none': hide }"
              :style="maskStyle"
              style="z-index:100;background-color:lightYellow; opacity:.5; width:176px; height:176px"
            ></div>
            <div
              id="super-mask"
              class="position-absolute"
            ...
            <div
              ...
              :style="{
                ...
                'background-position': `-${parseInt(maskStyle.left) *
                  2}px -${parseInt(maskStyle.top) * 2}px`,
              }"
            ></div>
        ...
        <div id="details" class="col pl-0">
          <h6 id="ptitle" class="font-weight-bold">{{ product.title }}</h6>
          <h6>
            <a
              id="psubtitle"
          ...
          <div class="alert alert-secondary small" role="alert">
            <div>
              <span>学员售价：</span>
              <h2 id="pprice" class="d-inline text-primary font-weight-bold">
                ¥{{ product.price.toFixed(2) }}
              </h2>
            </div>
            <div>
              <span>服务承诺：</span>
              <span id="ppromise">{{ product.promise }}</span>
            </div>
          </div>
          <!-- 客服 -->
          <p class="mb-1">
